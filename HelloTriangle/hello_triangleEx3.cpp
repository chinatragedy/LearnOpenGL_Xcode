//
//  hello_triangleEx3.cpp
//  HelloTriangle
//
//  Created by 张靖豪 on 2019/12/27.
//  Copyright © 2019 张靖豪. All rights reserved.
//

#include "hello_triangleEx3.hpp"
#include <glad/glad.h>
...
int main()
{
    ...
    // fragment shader
    int fragmentShaderG = glCreateShader(GL_FRAGMENT_SHADER);
    glShaderSource(fragmentShaderG, 1, &fragmentShaderSourceGreen, NULL);
    glCompileShader(fragmentShaderG);
    // check for shader compile errors
    glGetShaderiv(fragmentShaderG, GL_COMPILE_STATUS, &success);
    if (!success)
    {
        glGetShaderInfoLog(fragmentShaderG, 512, NULL, infoLog);
        std::cout << "ERROR::SHADER::FRAGMENT::COMPILATION_FAILED\n" << infoLog << std::endl;
    }
    //fragment shader
    int fragmentShaderY = glCreateShader(GL_FRAGMENT_SHADER);
    ...
    glAttachShader(shaderProgram1, fragmentShaderG);
